#------------------------------------------------------
# The program uses the opencv library to detect faces
# in streamlit
#------------------------------------------------------
...
def biometric_login():
	...
	if choice == 'Save Image':
		...
		st.markdown("Built with Streamlit by [Sumeet,Pat, Bipasha, Hossain, Bill]")
		st.text("Sumeet,Pat, Bipasha, Hossain, Bill")
		st.success("Sumeet,Pat, Bipasha, Hossain, Bill")
